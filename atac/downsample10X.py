...
class Downsample:
    ...
    def __init__(self, args):
        ...
        self.out_fq1 = f"{self.args.outdir}/downsample_{self.fq1.split('/')[-1].split('_')[0]}_S1_L001_R1_001.fastq.gz"
        self.out_fq2 = f"{self.args.outdir}/downsample_{self.fq2.split('/')[-1].split('_')[0]}_S1_L001_R2_001.fastq.gz"
        self.out_fq3 = f"{self.args.outdir}/downsample_{self.fq3.split('/')[-1].split('_')[0]}_S1_L001_R3_001.fastq.gz"
...
if __name__ == '__main__':
    ...
    parser.add_argument("--outdir", help="output_dir", default='Downsample10X')
